...
import type { Appointment, AppointmentListItem, AppointmentWithDetails, PaginatedResponse } from '@/types';
...
export function useAppointment(id: string) {
    return useQuery({
        ...
        queryFn: () => api.get<AppointmentWithDetails>(endpoints.appointments.get(id)),
        enabled: !!id,
